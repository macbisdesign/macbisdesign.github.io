...
| --------------- | ----------------- | ----------- | --------------------------------------------- | ----------- |
| `bottomBg`      | `bottom-bg`       |             | `"black" \| "blue" \| "gray" \| "light-gray"` | `undefined` |
| `bottomColor`   | `bottom-color`    |             | `"white"`                                     | `undefined` |
| `filled`        | `filled`          |             | `boolean`                                     | `false`     |
| `flexCol`       | `flex-col`        |             | `boolean`                                     | `false`     |
| `hasBorder`     | `has-border`      |             | `boolean`                                     | `false`     |
| `hasBorders`    | `has-borders`     |             | `boolean`                                     | `false`     |
| `showAbovePart` | `show-above-part` |             | `boolean`                                     | `true`      |
