        ...
        return (
            <Host>
                <header class={`header-component header-component--${this.size} header-component--${this.theme}`}>
                    <div class={`header-logo header-logo--${this.headerLogoTheme} header-logo-seperator--${this.headerLogoTheme}`}></div>
                        ...
                        <div class="content-left">
                            ...
                            }
                            {
                                ...
                                <div class="search-bar-container">
                                    ...
                                    <input type="text" class={`search-bar search-bar--${this.searchTheme} search-bar-text--${this.searchTextTheme}`} name="search-bar-input" id="search-bar-input" placeholder="Search"/>
                                </div>
                            } 
                        </div>
                ...
                </header>
                {
                    ...
                    <nav class={`nav-container nav-container-bottom nav-container--${this.navTheme}`}>
                        <slot name="nav-slot" />
                    </nav>
                }
            </Host>
