...
| ----------------------- | ------------------------- | ----------- | ------------------------------- | ----------- |
| `accountContainer`      | `account-container`       |             | `boolean`                       | `true`      |
| `accountContainerTheme` | `account-container-theme` |             | `"blue" \| "dark" \| "white"`   | `'white'`   |
| `accountLabel`          | `account-label`           |             | `string`                        | `undefined` |
| `headerLogo`            | `header-logo`             |             | `string`                        | `undefined` |
| `headerLogoDash`        | `header-logo-dash`        |             | `boolean`                       | `false`     |
| `headerLogoDashTheme`   | `header-logo-dash-theme`  |             | `"blue" \| "white"`             | `'white'`   |
| `headerLogoStretched`   | `header-logo-stretched`   |             | `boolean`                       | `false`     |
...
| `navSeparatorTheme`     | `nav-separator-theme`     |             | `"blue" \| "white"`             | `'white'`   |
...
| `size`                  | `size`                    |             | `"normal" \| "slim"`            | `'normal'`  |
| `theme`                 | `theme`                   |             | `"blue" \| "dark" \| "white"`   | `undefined` |
