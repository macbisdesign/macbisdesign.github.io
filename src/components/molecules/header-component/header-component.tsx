    ...
    return (
      <Host>
        <header class={`header-component header-component--${this.size} header-component--${this.theme}`}>
          <div
            class={`${this.headerLogoDash ? 'header-logo--dash' : ''} ${
              this.headerLogoDashTheme === 'blue' ? 'header-logo--dash-blue' : this.headerLogoDashTheme === 'white' ? 'header-logo--dash-white' : ''
            } ${this.headerLogoStretched ? 'header-logo--stretched' : ''} header-logo--${this.headerLogoTheme} header-logo`}
          ></div>
          ...
          <div class={`header-content`}>
            <div class={`content-left`}>
              ...
              {this.navSeparator && (
                <h1 class={`inspect ${this.navSeparatorTheme === 'blue' ? 'inspect--blue' : this.navSeparatorTheme === 'white' ? 'inspect--white' : ''} `}>Inspect</h1>
              )}
            ...
            <div class="content-right">
              ...
              {this.accountContainer && (
                <div class={`account-container account-container--${this.accountContainerTheme}`}>
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" height="18px" width="18px">
