...
export class ButtonComponent {
  ...
  @Prop() visual: 'warning' | 'error' | 'success' | 'primary' | 'secondary' = 'primary';
    ...
    return (
      <Host>
        <button
          ...
          class={cn('inline-flex items-center gap-x-2.5 text-base font-bold rounded focus:ring focus:ring-[#3D94D0] focus:ring-offset-4 focus-visible:outline-none', {
            'px-6 py-1': this.size === 'sm',
            'px-[14px] py-2 button-sold': this.size === 'base',
            ...
            'text-[#0071BC] hover:text-[#205493] focus:text-[#0071BC] active:border-[#112E51] disabled:text-[#4F4F4F]': this.variant === 'ghost' && this.visual === 'primary',
            'text-[#046B99] disabled:text-[#4F4F4F]': this.variant === 'ghost' && this.visual === 'secondary',
            'text-[#2E8540] hover:text-[#2E8540] focus:text-[#2E8540] active:text-[#174320] disabled:text-[#4F4F4F]': this.variant === 'ghost' && this.visual === 'success',
            'text-[#171717] disabled:text-[#4F4F4F]': this.variant === 'ghost' && this.visual === 'warning',
            'text-[#E51C3E] hover:text-[#B31E22] focus:text-[#E51C3E] active:text-[#981B1F] disabled:text-[#4F4F4F]': this.variant === 'ghost' && this.visual === 'error',
          })}
